          ...
          <div className="text-center lg:text-left animate-slide-up">
            ...
            <div className="grid grid-cols-3 gap-6 pt-8 border-t border-gray-200">
              <div className="text-center lg:text-left">
                <div className="text-2xl sm:text-3xl font-bold text-eservice-blue">1+</div>
                <div className="text-sm text-professional-gray">Client Projects</div>
              </div>
              <div className="text-center lg:text-left">
                <div className="text-2xl sm:text-3xl font-bold text-knowledge-teal">5+</div>
            ...
            <div className="relative">
              ...
              <div className="absolute -top-6 -right-6 bg-white rounded-xl shadow-lg p-4 transform -rotate-3 hover:rotate-0 transition-transform duration-500">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="text-lg font-bold text-knowledge-teal">All</div>
