...
import { ArrowLeft, CheckCircle, Clock, Mail, MapPin, MessageCircle, Phone, Send } from "lucide-react"
...
${formData.message}
      `.trim()
            ...
            window.location.href = `mailto:help.eservicesolution@gmail.com?subject=New Contact Form Submission&body=${encodeURIComponent(emailBody)}`
        }
                                ...
                                <button
                                    onClick={() =>
                                        contactMethod === "whatsapp"
                                            ...
                                            : (window.location.href = "mailto:help.eservicesolution@gmail.com")
                                    }
                                    className="inline-flex items-center px-6 py-3 bg-green-500 text-white font-semibold rounded-lg hover:bg-green-600 transition-colors duration-200"
                                >
                                    <MessageCircle className="w-5 h-5 mr-2" />
